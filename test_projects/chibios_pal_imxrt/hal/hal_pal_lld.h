 ...
 * @notapi
 */
#define pal_lld_readport(port) ((ioportmask_t)((port)->PSR)) //could also use port->DR
 ...
 * @notapi
 */
#define pal_lld_readlatch(port) ((ioportid_t)((port)->DR)
 ...
 * @notapi
 */
#define pal_lld_writeport(port, bits) ((port)->DR = (uint32_t)bits
